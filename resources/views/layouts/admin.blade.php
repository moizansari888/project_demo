...
{{--                </a>--}}
{{--                <ul class="dropdown-menu dropdown-menu-right dropdown-user dropdown-default">--}}
{{--                    <li><a  class="dropdown-item" href="#"><i class="fa fa-user fa-fw"></i> User Profile</a>--}}
{{--                    </li>--}}
{{--                    <li><a  class="dropdown-item" href="#"><i class="fa fa-gear fa-fw"></i> Settings</a>--}}
{{--                    </li>--}}
{{--                    <li><a  class="dropdown-item" href="{{ url('/logout') }}"><i class="fa fa-sign-out fa-fw"></i> Logout</a>--}}
{{--                    </li>--}}
{{--                </ul>--}}
{{--                <!-- /.dropdown-user -->--}}
{{--            </li>--}}
